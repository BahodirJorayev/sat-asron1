...
export const INITIAL_MOCK_TESTS: MockTest[] = [
  {
    ...
    categoryId: '11111111-c001-4000-8000-000000000001',
    categorySlug: 'official-bluebook',
    isPublished: true,
    isProOnly: false,
    isPrivate: false,
  ...
  },
  {
    ...
    categoryId: '22222222-c002-4000-8000-000000000002',
    categorySlug: 'private-course',
    isPublished: true,
    isProOnly: false,
    isPrivate: true,
  ...
  },
  {
    ...
    categoryId: '33333333-c003-4000-8000-000000000003',
