...
export const CleanDashboardView: React.FC<Props> = ({
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto pb-12 font-sans text-[#1E1B18] dark:text-[#F8FAFC]">
      ...
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-1 border-b border-[#E5E0D8] dark:border-[#1E293B]">
        <div>
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-white dark:bg-[#0F172A] border border-[#E5E0D8] dark:border-[#1E293B] text-xs font-mono text-[#64748B] dark:text-[#94A3B8] self-start sm:self-auto shadow-2xs">
      ...
      <section aria-label="Asosiy Metrikalar" className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {/* Metric 1: Streak */}
        <div className="p-5 rounded-2xl bg-white dark:bg-[#0D1527] border border-[#E5E0D8] dark:border-[#1E293B] shadow-xs flex flex-col justify-between">
          <div className="text-[11px] font-mono uppercase tracking-wider text-[#64748B] dark:text-[#94A3B8] font-semibold">
            Ketma-ketlik (Streak)
          </div>
          <div className="my-2.5">
            <div className="text-3xl sm:text-4xl font-extrabold font-mono tabular-nums text-[#1E1B18] dark:text-[#F8FAFC] tracking-tight">
      ...
      <section aria-label="Asosiy Modullar" className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <button
            ...
            className="p-5 rounded-2xl bg-white dark:bg-[#0D1527] border border-[#E5E0D8] dark:border-[#1E293B] hover:border-[#334155] transition-all text-left flex items-start justify-between group cursor-pointer shadow-xs"
          >
            ...
            <ArrowUpRight size={16} className="text-[#64748B] group-hover:text-[#1E1B18] dark:group-hover:text-[#F8FAFC] transition-colors shrink-0 stroke-[1.5]" />
          </button>
      ...
      <section aria-label="So‘nggi Faoliyat" className="p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#0D1527] border border-[#E5E0D8] dark:border-[#1E293B] shadow-xs">
        ...
        {questionsDone === 0 && mistakes.length === 0 ? (
          <div className="py-8 text-center space-y-2 border border-dashed border-[#E5E0D8] dark:border-[#1E293B] rounded-xl bg-[#FAF8F5] dark:bg-[#0A0F1D]/40">
